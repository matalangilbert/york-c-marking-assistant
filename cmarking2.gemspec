Gem::Specification.new do |s|
  ...
  s.version = "1.0.2"  # i.e. (major,non-backwards compatable).(backwards compatable).(bugfix)
  ...
  s.email = "freefallertam@gmail.com" # optional
  s.summary = "A marking assistent for the University of York Introduction to C course." # optional
  s.homepage = "http://www.matalangilbert.blogspot.com"  # optional
  s.description = "A marking assistent for the York University Introduction to C course. No official association with the University of York." # optional
